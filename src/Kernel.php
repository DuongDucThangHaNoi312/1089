...
use App\Compiler\AdminCompilerPass;
use App\Compiler\AdminPoolCompilerPass;
use App\DependencyInjection\Compiler\StripeBundleModelManagerPass;
...
class Kernel extends BaseKernel
{
    ...
    protected function build(ContainerBuilder $container)
    {
        ...
        $container
            ...
            ->addCompilerPass(new StripeBundleModelManagerPass())
        ;
    }
}
