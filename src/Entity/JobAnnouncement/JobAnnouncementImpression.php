...
/**
 * @ORM\Entity(repositoryClass="App\Repository\JobAnnouncement\JobAnnouncementImpressionRepository")
 */
class JobAnnouncementImpression
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\JobAnnouncement", inversedBy="jobAnnouncementImpressions", cascade={"persist"})
     * @ORM\JoinColumn(onDelete="CASCADE", nullable=false)
     */
    private $jobAnnouncement;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User\JobSeekerUser", inversedBy="jobAnnouncementImpressions", cascade={"persist"})
