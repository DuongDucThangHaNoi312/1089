...
/**
 * @ORM\Entity(repositoryClass="App\Repository\User\JobSeekerUser\SavedJobAnnouncementRepository")
 * @UniqueEntity(fields={"jobSeekerUser", "jobAnnouncement"}, message="You've already saved this job announcement.")
 */
class SavedJobAnnouncement
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User\JobSeekerUser", inversedBy="savedJobAnnouncements")
